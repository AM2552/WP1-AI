...
last_trained_epoch = 400
additional_epochs = 100  # for example, to train for 100 more epochs
preset_name = 'Preset1'
model_path = f'bird_classification_model_{preset_name}_continued.h5'
...
parameter_presets = {
    'Preset1': (6, 3, 0.00009, 'adam', 300, True),
