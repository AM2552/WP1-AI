...
############################################
source_folder = '/Users/Xandi/Desktop/Datasets/bcd'
new_dataset_path = './datasets/bird_cat_dog'
############################################
...
def split_dataset():
    ...
    for element in tqdm(classes, desc="Processing classes"):
        ...
        train_split_idx = int(total_images * 0.9)
        validation_split_idx = train_split_idx + int(total_images * 0.05)
