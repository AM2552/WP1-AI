...
parameter_presets = {
    ...
    #'Preset2': (6, 3, 0.0001, 'adam', 50, True),
    #'Preset3': (7, 3, 0.0001, 'adam', 50, True),
    #'Preset4': (4, 3, 0.0001, 'adam', 50, True),
    #'Preset5': (5, 3, 0.0001, 'adam', 50, True),
    #'Preset6': (6, 3, 0.0001, 'adam', 50, True),
    #'Preset7': (7, 3, 0.0001, 'adam', 50, True),
    #'Preset8': (8, 3, 0.0001, 'adam', 50, True)
}
...
for preset_name, parameters in parameter_presets.items():
    ...
    plt.tight_layout()
    plt.savefig(f'bcd_{preset_name}.png')
