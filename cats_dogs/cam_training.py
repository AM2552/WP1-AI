...
class GradCAMCallback(Callback):
    def __init__(self, model, cat_img_path, dog_img_path, last_conv_layer_name):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if cat_img_array is not None:
            ...
            save_and_display_gradcam(self.cat_img_path, cat_heatmap, (original_cat_width, original_cat_height), cam_path=f'cats_dogs/test_images/grad_cam/cat/grad_cam_cat_epoch_{epoch + 1}.jpg')
        ...
        if dog_img_array is not None:
            ...
            save_and_display_gradcam(self.dog_img_path, dog_heatmap, (original_dog_width, original_dog_height), cam_path=f'cats_dogs/test_images/grad_cam/dog/grad_cam_dog_epoch_{epoch + 1}.jpg')
...
def train_model(conv_layers, dense_layers, learning_rate, epochs, dropout=bool, cat_img_path=str(), dog_img_path=str(), last_conv_layer_name=str(), preset_name=str()):
    model = Sequential()
    ...
    grad_cam_callback = GradCAMCallback(model, cat_img_path, dog_img_path, last_conv_layer_name)
...
parameter_presets = {
    'Preset1': (6, 3, 0.0001, 50, True, 'cats_dogs/test_images/cat/cat2.jpg', 'cats_dogs/test_images/dog/dog2.jpg', 'conv2d_5')
