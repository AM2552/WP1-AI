...
def main():
    parser = argparse.ArgumentParser(description='Train or resume training a Faster R-CNN model.')
...
# python amphibians/resume_training.py --resume some_best_model.pth --start_epoch 000