...
# Configuration
ANNOTATIONS_FILE = "amphibians/amphibia_annotations.json"  # Make sure this path is correct
IMG_DIR = "datasets/amphibia/training"  # Change this to validation or test if needed
